...
do_action( 'wpc_client_add_meta_boxes', 'wp-client_page_accumulating_invoice', '' );
do_action( 'wpc_client_add_meta_boxes_wp-client_page_accumulating_invoice' , '' );
...
$can_edit = ( in_array( $status, array( 'ended' ) ) ) ? 0 : 1;
    ...
    <h2>
        ...
        <?php
            if ( isset( $_GET['id'] ) && '' != $_GET['id'] ) {
                _e( 'Edit Accumulating Profile', WPC_CLIENT_TEXT_DOMAIN );
            } else {
                _e( 'Add Accumulating Profile', WPC_CLIENT_TEXT_DOMAIN );
            }
        ?>
    ...
    <div id="poststuff">
        <div id="post-body" class="metabox-holder columns-2 not_bold">
            ...
            <div id="postbox-container-1" class="postbox-container">
                ...
                <?php
                    do_meta_boxes( 'wp-client_page_accumulating_invoice', 'side', array( 'data' => $data, 'option' => $option )  ) ;
                ?>
             </div>
             <div id="postbox-container-2" class="postbox-container">
                <?php do_meta_boxes('wp-client_page_accumulating_invoice', 'normal', array( 'data' => $data, 'option' => $option ) ); ?>
            </div>
        </div><!-- #post-body -->
  </div> <!-- #poststuff -->
...
<script type="text/javascript" language="javascript">
    ...
    jQuery( document ).ready( function() {
        ...
        jQuery( '#save_data_send' ).click( function() {
            ...
            if ( '' !== jQuery( "#wpc_data_from_date" ).val() || jQuery("#wpc_last_day_month").is(':checked') ) {
