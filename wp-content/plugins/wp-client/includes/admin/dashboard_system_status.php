                         ...
                         <td><?php
                            ...
                            foreach ( $active_plugins as $plugin ) {
                                ...
                                if ( $plugin_data['AuthorURI'] && $plugin_data['Author'] )
                                    $plugin_data['Author'] = '<a href="' . $plugin_data['AuthorURI'] . '" title="' . esc_attr__( 'Visit author homepage', WPC_CLIENT_TEXT_DOMAIN ) . '" target="_blank">' . $plugin_data['Author'] . '</a>';


                                if ( ! empty( $plugin_data['Name'] ) ) {
                                    if ( false !== get_option( 'whtlwpc_settings' ) &&  0 === strpos( $plugin_data['Name'],  WPC()->plugin['old_title'] ) ){
                                        $wc_plugins[] = str_replace( WPC()->plugin['old_title'], WPC()->plugin['title'], $plugin_data['Name'] ) . ' ' . __( 'version', WPC_CLIENT_TEXT_DOMAIN ) . ' ' . $plugin_data['Version'] . $version_string;
                                    } else {
                ...
                <tbody>
                    ...
                    <tr>
                        ...
                        if ( '' != $permalink_structure ) {
                            ...
                            echo __( 'Default', WPC_CLIENT_TEXT_DOMAIN )
                                    . '<a href="admin.php?page=wpclients&tab=system_status&wpc_custom_trigger=change_permalink">'
                                    . __( ' (Change to Post Name)', WPC_CLIENT_TEXT_DOMAIN ) . '</a>' ;
                        }
                        ?>
