...
class WPC_Customize {
        ...
        $sections = array(
            ...
            'page_access' => array(
                ...
                'wpc_client_client_pages_a' => array(
                    'title' => sprintf( __( '%s Links', WPC_CLIENT_TEXT_DOMAIN ), WPC()->custom_titles['portal_page']['s'] ),
    ...
    */
    function get_style_schemes() {
        ...
        $style_schemes = WPC()->get_settings( 'style_schemes_settings' );
...
//            $sections = $this->get_default_sections();
        ...
        $wpc_style_settings = WPC()->get_settings( 'style_' . $scheme . '_sections' );
...
//            }
        ...
        foreach( $wpc_style_settings as $section_name => $section_values ) {
...
//            }
    ...
    function render_element_section( $element_name, $element, $section_name ) {
        ...
        <li class="control-section accordion-section" data-eID="<?php echo $element_id ?>" id="accordion-section-colors">
            ...
            <ul class="accordion-section-content">
                <li><div class="properties_editor_place"></div></li>
            </ul>
    ...
    */
    function reset_style_settings() {
        ...
        WPC()->settings()->update( array(), 'style_settings' );

        $target_path = WPC()->get_upload_dir();
    ...
    */
    function save_style_settings( $scheme_settings, $settings ) {
        ...
        WPC()->settings()->update( $wpc_style_schemes, 'style_schemes_settings' );
        WPC()->settings()->update( $settings, 'style_' . $scheme_key . '_sections' );
