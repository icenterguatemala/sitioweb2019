...
class MikadoSkin extends ServiceMasterMikadoSkinAbstract {
    /**
     * Skin constructor. Hooks to servicemaster_mikado_admin_scripts_init and servicemaster_mikado_enqueue_admin_styles
     */
    public function __construct() {
        $this->skinName = 'mikado';

        //hook to
        add_action('servicemaster_mikado_admin_scripts_init', array($this, 'registerStyles'));
        add_action('servicemaster_mikado_admin_scripts_init', array($this, 'registerScripts'));

        add_action('servicemaster_mikado_enqueue_admin_styles', array($this, 'enqueueStyles'));
        add_action('servicemaster_mikado_enqueue_admin_scripts', array($this, 'enqueueScripts'));

        add_action('servicemaster_mikado_enqueue_meta_box_styles', array($this, 'enqueueMetaStyles'));
        add_action('servicemaster_mikado_enqueue_meta_box_scripts', array($this, 'enqueueScripts'));
    ...
    public function registerScripts() {
        ...
        foreach ($this->scripts as $scriptHandle => $scriptPath) {
            servicemaster_mikado_register_skin_script($scriptHandle, $scriptPath);
        }
    }
    ...
    public function registerStyles() {
        ...
        foreach ($this->styles as $styleHandle => $stylePath) {
            servicemaster_mikado_register_skin_style($styleHandle, $stylePath);
        }
    ...
    public function renderOptions() {
        ...
        $tab    		= servicemaster_mikado_get_admin_tab();
        $active_page 	= $servicemaster_Framework->mkdOptions->getAdminPageFromSlug($tab);
     ...
     *
*@param ServiceMasterMikadoAdminPage $page current page to load
...
*@param ServiceMasterMikadoAdminPage $page current page to load
    ...
    public function renderImport() { ?>
        <div class="mkd-options-page mkd-page">
            <?php $this->getHeader(servicemaster_mikado_get_theme_info_item('Name'), servicemaster_mikado_get_theme_info_item('Version'), false); ?>
            <div class="mkd-page-content-wrapper">
                <div class="mkd-page-content">
                    <div class="mkd-page-navigation mkd-tabs-wrapper vertical left clearfix">
