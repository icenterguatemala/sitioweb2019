...
$servicemaster_options_fontstyle     = array(
	"normal" => "normal",
	"italic" => "italic"
);
$servicemaster_options_fontweight    = array(
	"100" => "100",
	"200" => "200",
	"300" => "300",
	"400" => "400",
...
$servicemaster_options_texttransform = array(
	"none"       => "None",
...
$servicemaster_options_fontdecoration = array(
	"none"      => "none",
	"underline" => "underline"
);

$servicemaster_options_arrows_type = array(
...
$servicemaster_options_double_arrows_type = array(
	'fa fa-angle-double-'          => 'fa-angle-double',
	'arrow_carrot-2'               => 'arrow_carrot-2',
	'arrow_carrot-2left_alt2'      => 'arrow_carrot 2 alt2',
	'icon-arrows-left-double-32'   => 'icon-arrows double',
...
$servicemaster_options_arrows_up_type = array(
