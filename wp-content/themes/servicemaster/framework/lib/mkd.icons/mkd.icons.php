...
/*
  Class: ServiceMasterMikadoIconCollections
...
class ServiceMasterMikadoIconCollections {
	...
	private function initIconCollections() {
		$this->addIconCollection('font_awesome', new ServiceMasterMikadoIconsFontAwesome("Font Awesome", "fa_icon"));
		$this->addIconCollection('font_elegant', new ServiceMasterMikadoIconsFontElegant("Font Elegant", "fe_icon"));
		$this->addIconCollection('ion_icons', new ServiceMasterMikadoIonIcons("Ion Icons", "ion_icon"));
		$this->addIconCollection('linea_icons', new ServiceMasterMikadoLineaIcons('Linea Icons', 'linea_icon'));
		$this->addIconCollection('linear_icons', new ServiceMasterMikadoLinearIcons('Linear Icons', 'linear_icon'));
		$this->addIconCollection('simple_line_icons', new ServiceMasterMikadoSimpleLineIcons('Simple Line Icons',
			'simple_line_icons'));
		$this->addIconCollection('dripicons', new ServiceMasterMikadoDripicons('Dripicons', 'dripicon'));
	}
	...
	public function getSocialVCParamsArray($iconPackDependency = array(), $iconCollectionPrefix = "", $emptyIconPack = false, $exclude = '') {
		...
		$iconPackParams = array(
			'type'        => 'dropdown',
			'heading'     => esc_html__('Icon pack', 'servicemaster'),
		...
		if (is_array($iconCollections) && count($iconCollections)) {
			foreach ($iconCollections as $key => $collection) {
				$iconSetParams[] = array(
					'type'        => 'dropdown',
					'class'       => '',
					'heading'     => esc_html__('Icon', 'servicemaster'),
					'param_name'  => $iconCollectionPrefix . $collection->param,
	...
	public function getWidgetIconParams() {
		...
		$iconPackParams[] = array(
			'type'    => 'dropdown',
			'title'   => esc_html__('Icon Pack', 'servicemaster'),
			'name'    => 'icon_pack',
			'options' => array(
	...
	public function getIconCollectionIcons(iServiceMasterMikadoIconCollection $collection) {
...
$servicemaster_IconCollections = ServiceMasterMikadoIconCollections::get_instance();