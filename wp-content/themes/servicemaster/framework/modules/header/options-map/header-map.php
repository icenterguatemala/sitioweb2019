...
if (!function_exists('servicemaster_mikado_header_options_map')) {

	function servicemaster_mikado_header_options_map() {
		...
		$panel_header = servicemaster_mikado_add_admin_panel(
			array(
				'page'  => '_header_page',
				'name'  => 'panel_header',
				'title' => esc_html__('Header', 'servicemaster')
		...
		servicemaster_mikado_add_admin_field(
			array(
				...
				'type'          => 'yesno',
				'default_value' => 'no',
				'label'         => esc_html__('Top Line', 'servicemaster'),
				'description'   => esc_html__('Enabling this option will show top line above header', 'servicemaster'),
				'parent'        => $panel_header,
				'args'          => array(
					"dependence"             => true,
		...
		$top_line_container = servicemaster_mikado_add_admin_container(array(
		...
		servicemaster_mikado_add_admin_field(
			array(
				...
				'type'          => 'yesno',
				'default_value' => 'no',
				'label'         => esc_html__('Top Bar', 'servicemaster'),
				'description'   => esc_html__('Enabling this option will show top bar area', 'servicemaster'),
				'parent'        => $panel_header,
				'args'          => array(
					"dependence"             => true,
					"dependence_hide_on_yes" => "",
		...
		$top_bar_container = servicemaster_mikado_add_admin_container(array(
		...
		servicemaster_mikado_add_admin_field(
			array(
				...
				'label'         => esc_html__('Choose top bar layout', 'servicemaster'),
				'description'   => esc_html__('Select the layout for top bar', 'servicemaster'),
				'options'       => array(
					'two-columns'   => esc_html__('Two columns', 'servicemaster'),
					'three-columns' => esc_html__('Three columns', 'servicemaster')
				),
				'args'          => array(
					'dependence' => true,
					'hide'       => array(
		...
		$top_bar_layout_container = servicemaster_mikado_add_admin_container(array(
		...
		servicemaster_mikado_add_admin_field(
			array(
				...
				'label'         => esc_html__('Choose column widths', 'servicemaster'),
				'description'   => '',
				'options'       => array(
					'30-30-30' => '33% - 33% - 33%',
					'25-50-25' => '25% - 50% - 25%'
		...
		$top_bar_two_columns_layout = servicemaster_mikado_add_admin_container(array(
		...
		$top_bar_in_grid_container = servicemaster_mikado_add_admin_container(array(
		...
		servicemaster_mikado_add_admin_field(array(
			...
			'description' => esc_html__('Set grid background color for top bar', 'servicemaster'),
		...
		servicemaster_mikado_add_admin_field(array(
			...
			'description' => esc_html__('Set grid background transparency for top bar', 'servicemaster'),
			'parent'      => $top_bar_in_grid_container,
		...
		servicemaster_mikado_add_admin_field(array(
			...
			'description' => esc_html__('Set background color for top bar', 'servicemaster'),
			'parent'      => $top_bar_container
		));
		...
		servicemaster_mikado_add_admin_field(array(
			...
			'description' => esc_html__('Set background transparency for top bar', 'servicemaster'),
			'parent'      => $top_bar_container,
			'args'        => array('col_width' => 3)
		));
		...
		servicemaster_mikado_add_admin_field(
			array(
				...
				'description'   => esc_html__('Set top bar border', 'servicemaster'),
				'parent'        => $top_bar_container,
				'args'          => array(
					"dependence"             => true,
					"dependence_hide_on_yes" => "",
		...
		servicemaster_mikado_add_admin_field(array(
			...
			'type'        => 'color',
			'label'       => esc_html__('Top Bar Border', 'servicemaster'),
			'description' => esc_html__('Set border color for top bar', 'servicemaster'),
		...
		servicemaster_mikado_add_admin_field(array(
			'name'        => 'top_bar_height',
			'type'        => 'text',
			'label'       => esc_html__('Top bar height', 'servicemaster'),
			'description' => esc_html__('Enter top bar height (Default is 37px)', 'servicemaster'),
			'parent'      => $top_bar_container,
			'args'        => array(
				'col_width' => 2,
				'suffix'    => 'px'
		...
		$panel_header_standard = servicemaster_mikado_add_admin_panel(
			array(
				'page'            => '_header_page',
				'name'            => 'panel_header_standard',
				'title'           => esc_html__('Header Standard', 'servicemaster'),
				'hidden_property' => 'header_type',
				'hidden_value'    => '',
				'hidden_values'   => array(
		...
		$menu_area_in_grid_header_standard_container = servicemaster_mikado_add_admin_container(
			array(
				'parent'          => $panel_header_standard,
		...
		servicemaster_mikado_add_admin_field(
			array(
				...
				'default_value' => '',
				'label'         => esc_html__('Grid Background Transparency', 'servicemaster'),
				'description'   => esc_html__('Set grid background transparency for header', 'servicemaster'),
				'args'          => array(
					'col_width' => 3
				)
			)
		...
		servicemaster_mikado_add_admin_field(
			array(
				...
				'default_value' => '',
				'label'         => esc_html__('Background color', 'servicemaster'),
				'description'   => esc_html__('Set background color for header', 'servicemaster')
			)
		);
		...
		servicemaster_mikado_add_admin_field(
			array(
				...
				'default_value' => '',
				'label'         => esc_html__('Background transparency', 'servicemaster'),
				'description'   => esc_html__('Set background transparency for header', 'servicemaster'),
				'args'          => array(
					'col_width' => 3
				)
			)
		...
		servicemaster_mikado_add_admin_field(
			array(
				...
				'description'   => esc_html__('Enter header height (default is 100px)', 'servicemaster'),
				'args'          => array(
					'col_width' => 3,
					'suffix'    => 'px'
				)
		...
		$panel_header_minimal = servicemaster_mikado_add_admin_panel(
			array(
				'page'            => '_header_page',
				'name'            => 'panel_header_minimal',
				'title'           => esc_html__('Header Minimal', 'servicemaster'),
				'hidden_property' => 'header_type',
				'hidden_value'    => '',
				'hidden_values'   => array(
					'header-vertical',
		...
		$menu_area_in_grid_header_minimal_container = servicemaster_mikado_add_admin_container(
			array(
				'parent'          => $panel_header_minimal,
		...
		$panel_header_divided = servicemaster_mikado_add_admin_panel(
			array(
				'page'            => '_header_page',
				'name'            => 'panel_header_divided',
				'title'           => esc_html__('Header Divided', 'servicemaster'),
				'hidden_property' => 'header_type',
				'hidden_value'    => '',
				'hidden_values'   => array(
					'header-standard',
		...
		$menu_area_in_grid_header_divided_container = servicemaster_mikado_add_admin_container(
			array(
				'parent'          => $panel_header_divided,
		...
		$panel_header_centered = servicemaster_mikado_add_admin_panel(
			array(
				'page'            => '_header_page',
				'name'            => 'panel_header_centered',
				'title'           => esc_html__('Header Centered', 'servicemaster'),
				'hidden_property' => 'header_type',
				'hidden_value'    => '',
				'hidden_values'   => array(
					'header-vertical',
		...
		$logo_area_in_grid_header_centered_container = servicemaster_mikado_add_admin_container(
			array(
				'parent'          => $panel_header_centered,
		...
		servicemaster_mikado_add_admin_field(
			array(
				...
				'default_value' => '',
				'label'         => esc_html__('Grid Background Transparency', 'servicemaster'),
				'description'   => esc_html__('Set grid background transparency', 'servicemaster'),
				'args'          => array(
					'col_width' => 3
				)
			)
		...
		$logo_area_in_grid_border_header_centered_container = servicemaster_mikado_add_admin_container(
			array(
				'parent'          => $logo_area_in_grid_header_centered_container,
		...
		servicemaster_mikado_add_admin_field(
			array(
				...
				'default_value' => '',
				'label'         => esc_html__('Background color', 'servicemaster'),
				'description'   => esc_html__('Set background color for logo area', 'servicemaster')
			)
		);
		...
		servicemaster_mikado_add_admin_field(
			array(
				...
				'default_value' => '',
				'label'         => esc_html__('Background transparency', 'servicemaster'),
				'description'   => esc_html__('Set background transparency for logo area', 'servicemaster'),
				'args'          => array(
					'col_width' => 3
				)
			)
		...
		$logo_area_border_header_centered_container = servicemaster_mikado_add_admin_container(
			array(
				'parent'          => $panel_header_centered,
		...
		servicemaster_mikado_add_admin_field(
			array(
				...
				'default_value' => '',
				'label'         => esc_html__('Border Color', 'servicemaster'),
				'description'   => esc_html__('Set border color for logo area', 'servicemaster'),
			)
		);
		...
		servicemaster_mikado_add_admin_field(
			array(
				...
				'default_value' => '',
				'label'         => esc_html__('Height', 'servicemaster'),
				'description'   => esc_html__('Enter logo area height (default is 155px)', 'servicemaster'),
				'args'          => array(
					'col_width' => 3,
					'suffix'    => 'px'
				)
		...
		$menu_area_in_grid_header_centered_container = servicemaster_mikado_add_admin_container(
			array(
				'parent'          => $panel_header_centered,
		...
		servicemaster_mikado_add_admin_field(
			array(
				...
				'default_value' => '',
				'label'         => esc_html__('Background color', 'servicemaster'),
				'description'   => esc_html__('Set background color for menu area', 'servicemaster')
			)
		);
		...
		servicemaster_mikado_add_admin_field(
			array(
				...
				'default_value' => '',
				'label'         => esc_html__('Background transparency', 'servicemaster'),
				'description'   => esc_html__('Set background transparency for menu area', 'servicemaster'),
				'args'          => array(
					'col_width' => 3
				)
			)
		...
		servicemaster_mikado_add_admin_field(
			array(
				...
				'description'   => esc_html__('Set border on menu area', 'servicemaster')
			)
		);
		...
		servicemaster_mikado_add_admin_field(
			array(
				...
				'default_value' => '',
				'label'         => esc_html__('Height', 'servicemaster'),
				'description'   => esc_html__('Enter menu area height (default is 100px)', 'servicemaster'),
				'args'          => array(
					'col_width' => 3,
					'suffix'    => 'px'
				)
		...
		$panel_header_standard_extended = servicemaster_mikado_add_admin_panel(
			array(
				'page'            => '_header_page',
				'name'            => 'panel_header_standard_extended',
				'title'           => esc_html__('Header Standard Extended', 'servicemaster'),
				'hidden_property' => 'header_type',
				'hidden_value'    => '',
				'hidden_values'   => array(
					'header-vertical',
		...
		$logo_area_in_grid_header_standard_extended_container = servicemaster_mikado_add_admin_container(
			array(
				'parent'          => $panel_header_standard_extended,
		...
		$logo_area_in_grid_border_header_standard_extended_container = servicemaster_mikado_add_admin_container(
			array(
				'parent'          => $logo_area_in_grid_header_standard_extended_container,
		...
		$logo_area_border_header_standard_extended_container = servicemaster_mikado_add_admin_container(
			array(
				'parent'          => $panel_header_standard_extended,
		...
		servicemaster_mikado_add_admin_field(
			array(
				...
				'default_value' => '',
				'label'         => esc_html__('Height', 'servicemaster'),
				'description'   => esc_html__('Enter logo area height (default is 90px)', 'servicemaster'),
				'args'          => array(
					'col_width' => 3,
					'suffix'    => 'px'
				)
		...
		$menu_area_in_grid_header_standard_extended_container = servicemaster_mikado_add_admin_container(
			array(
				'parent'          => $panel_header_standard_extended,
		...
		servicemaster_mikado_add_admin_field(
			array(
				...
				'default_value' => '',
				'label'         => esc_html__('Height', 'servicemaster'),
				'description'   => esc_html__('Enter menu area height (default is 80px)', 'servicemaster'),
				'args'          => array(
					'col_width' => 3,
					'suffix'    => 'px'
				)
		...
		$panel_header_box = servicemaster_mikado_add_admin_panel(
			array(
				'page'            => '_header_page',
				'name'            => 'panel_header_box',
				'title'           => esc_html__('Header "In The Box"', 'servicemaster'),
				'hidden_property' => 'header_type',
				'hidden_value'    => '',
				'hidden_values'   => array(
					'header-standard',
        ...
        servicemaster_mikado_add_admin_field(
			array(
				...
				'type'          => 'select',
				'default_value' => 'left',
				'name'          => 'menu_area_position_header_box',
				'options'       => array(
					'center' => esc_html__('Center', 'servicemaster'),
					'left'   => esc_html__('Left', 'servicemaster'),
					'right'  => esc_html__('Right', 'servicemaster')
		...
		$panel_header_tabbed = servicemaster_mikado_add_admin_panel(
			array(
				'page'            => '_header_page',
				'name'            => 'panel_header_tabbed',
				'title'           => esc_html__('Header Tabbed', 'servicemaster'),
				'hidden_property' => 'header_type',
				'hidden_value'    => '',
				'hidden_values'   => array(
					'header-standard',
		...
		do_action('servicemaster_mikado_header_options_map');

		$panel_header_vertical = servicemaster_mikado_add_admin_panel(
			array(
				'page'            => '_header_page',
				'name'            => 'panel_header_vertical',
				'title'           => esc_html__('Header Vertical', 'servicemaster'),
				'hidden_property' => 'header_type',
				'hidden_value'    => '',
				'hidden_values'   => array(
					'header-standard',
		...
		servicemaster_mikado_add_admin_field(
			array(
				...
				'description'   => esc_html__('Set shadow on vertical header', 'servicemaster'),
			)
		);
		...
		$panel_header_vertical_compact = servicemaster_mikado_add_admin_panel(
			array(
				'page'            => '_header_page',
				'name'            => 'panel_header_vertical_compact',
				'title'           => esc_html__('Header Vertical - Compact', 'servicemaster'),
				'hidden_property' => 'header_type',
				'hidden_value'    => '',
				'hidden_values'   => array(
					'header-standard',
		...
		servicemaster_mikado_add_admin_field(
			array(
				...
				'default_value' => 'yes',
				'label'         => esc_html__('Shadow', 'servicemaster'),
				'description'   => esc_html__('Set shadow on vertical compact header', 'servicemaster'),
			)
		);

		$panel_sticky_header = servicemaster_mikado_add_admin_panel(
			array(
				'title'           => esc_html__('Sticky Header', 'servicemaster'),
		...
		servicemaster_mikado_add_admin_field(
			array(
				...
				'type'        => 'text',
				'label'       => esc_html__('Scroll Amount for Sticky', 'servicemaster'),
				'description' => esc_html__('Enter scroll amount for Sticky Menu to appear (deafult is header height)', 'servicemaster'),
		...
		$sticky_header_in_grid_container = servicemaster_mikado_add_admin_container(array(
		...
		servicemaster_mikado_add_admin_field(array(
			...
			'type'        => 'color',
			'label'       => esc_html__('Grid Background Color', 'servicemaster'),
			'description' => esc_html__('Set grid background color for sticky header', 'servicemaster'),
		...
		servicemaster_mikado_add_admin_field(array(
			...
			'type'        => 'text',
			'label'       => esc_html__('Sticky Header Grid Transparency', 'servicemaster'),
			'description' => esc_html__('Enter transparency for sticky header grid (value from 0 to 1)', 'servicemaster'),
			'parent'      => $sticky_header_in_grid_container,
			'args'        => array(
				'col_width' => 1
			)
		...
		servicemaster_mikado_add_admin_field(array(
			...
			'type'        => 'color',
			'label'       => esc_html__('Background Color', 'servicemaster'),
			'description' => esc_html__('Set background color for sticky header', 'servicemaster'),
			'parent'      => $panel_sticky_header
		));
		...
		servicemaster_mikado_add_admin_field(array(
			...
			'type'        => 'text',
			'label'       => esc_html__('Sticky Header Transparency', 'servicemaster'),
			'description' => esc_html__('Enter transparency for sticky header (value from 0 to 1)', 'servicemaster'),
			'parent'      => $panel_sticky_header,
			'args'        => array(
				'col_width' => 1
			)
		...
		servicemaster_mikado_add_admin_field(array(
			...
			'type'        => 'text',
			'label'       => esc_html__('Sticky Header Height', 'servicemaster'),
			'description' => esc_html__('Enter height for sticky header (default is 100px)', 'servicemaster'),
			'parent'      => $panel_sticky_header,
			'args'        => array(
				'col_width' => 2,
				'suffix'    => 'px'
		...
		$group_sticky_header_menu = servicemaster_mikado_add_admin_group(array(
			'title'       => esc_html__('Sticky Header Menu', 'servicemaster'),
			'name'        => 'group_sticky_header_menu',
			'parent'      => $panel_sticky_header,
			'description' => esc_html__('Define styles for sticky menu items', 'servicemaster'),
		));

		$row1_sticky_header_menu = servicemaster_mikado_add_admin_row(array(
			'name'   => 'row1',
		...
		$row2_sticky_header_menu = servicemaster_mikado_add_admin_row(array(
			'name'   => 'row2',
			'parent' => $group_sticky_header_menu
		));
		...
		$row3_sticky_header_menu = servicemaster_mikado_add_admin_row(array(
			'name'   => 'row3',
			'parent' => $group_sticky_header_menu
		));
		...
		$panel_fixed_header = servicemaster_mikado_add_admin_panel(
			array(
				'title'           => esc_html__('Fixed Header', 'servicemaster'),
		...
		servicemaster_mikado_add_admin_field(array(
			...
			'default_value' => '',
			'label'         => esc_html__('Grid Background Color', 'servicemaster'),
			'description'   => esc_html__('Set grid background color for fixed header', 'servicemaster'),
		...
		servicemaster_mikado_add_admin_field(array(
			...
			'type'          => 'text',
			'default_value' => '',
			'label'         => esc_html__('Header Transparency Grid', 'servicemaster'),
			'description'   => esc_html__('Enter transparency for fixed header grid (value from 0 to 1)', 'servicemaster'),
			'parent'        => $panel_fixed_header,
			'args'          => array(
				'col_width' => 1
			)
		...
		servicemaster_mikado_add_admin_field(array(
			...
			'default_value' => '',
			'label'         => esc_html__('Background Color', 'servicemaster'),
			'description'   => esc_html__('Set background color for fixed header', 'servicemaster'),
			'parent'        => $panel_fixed_header
		));
		...
		servicemaster_mikado_add_admin_field(array(
			...
			'type'        => 'text',
			'label'       => esc_html__('Header Transparency', 'servicemaster'),
			'description' => esc_html__('Enter transparency for fixed header (value from 0 to 1)', 'servicemaster'),
			'parent'      => $panel_fixed_header,
			'args'        => array(
				'col_width' => 1
			)
		...
		$panel_main_menu = servicemaster_mikado_add_admin_panel(
			array(
				'title'           => esc_html__('Main Menu', 'servicemaster'),
		...
		servicemaster_mikado_add_admin_section_title(
			array(
				...
				'name'   => 'main_menu_area_title',
				'title'  => esc_html__('Main Menu General Settings', 'servicemaster')
			)
		);

		$drop_down_group = servicemaster_mikado_add_admin_group(
			array(
				'parent'      => $panel_main_menu,
				'name'        => 'drop_down_group',
				'title'       => esc_html__('Main Dropdown Menu', 'servicemaster'),
				'description' => esc_html__('Choose a color and transparency for the main menu background (0 = fully transparent, 1 = opaque)', 'servicemaster')
			)
		);

		$drop_down_row1 = servicemaster_mikado_add_admin_row(
			array(
		...
		$drop_down_padding_group = servicemaster_mikado_add_admin_group(
			array(
				'parent'      => $panel_main_menu,
				'name'        => 'drop_down_padding_group',
				'title'       => esc_html__('Main Dropdown Menu Padding', 'servicemaster'),
				'description' => esc_html__('Choose a top/bottom padding for dropdown menu', 'servicemaster')
			)
		);

		$drop_down_padding_row = servicemaster_mikado_add_admin_row(
			array(
		...
		servicemaster_mikado_add_admin_field(
			array(
				...
				'label'         => esc_html__('Main Dropdown Menu Appearance', 'servicemaster'),
				'description'   => esc_html__('Choose appearance for dropdown menu', 'servicemaster'),
				'options'       => array(
					'dropdown-default'           => esc_html__('Default', 'servicemaster'),
					'dropdown-slide-from-bottom' => esc_html__('Slide From Bottom', 'servicemaster'),
					'dropdown-slide-from-top'    => esc_html__('Slide From Top', 'servicemaster'),
					'dropdown-animate-height'    => esc_html__('Animate Height', 'servicemaster'),
					'dropdown-slide-from-left'   => esc_html__('Slide From Left', 'servicemaster')
				)
			)
		);
		...
		servicemaster_mikado_add_admin_field(
			array(
				...
				'default_value' => '',
				'label'         => esc_html__('Dropdown position', 'servicemaster'),
				'description'   => esc_html__('Enter value in percentage of entire header height', 'servicemaster'),
				'args'          => array(
					'col_width' => 3,
					'suffix'    => '%'
				)
		...
		$first_level_group = servicemaster_mikado_add_admin_group(
			array(
				'parent'      => $panel_main_menu,
				'name'        => 'first_level_group',
				'title'       => esc_html__('1st Level Menu', 'servicemaster'),
				'description' => esc_html__('Define styles for 1st level in Top Navigation Menu', 'servicemaster')
			)
		);

		$first_level_row1 = servicemaster_mikado_add_admin_row(
			array(
		...
		$first_level_row2 = servicemaster_mikado_add_admin_row(
			array(
				'parent' => $first_level_group,
		...
		$first_level_row3 = servicemaster_mikado_add_admin_row(
			array(
				'parent' => $first_level_group,
		...
		servicemaster_mikado_add_admin_field(
			array(
				...
				'default_value' => '',
				'label'         => esc_html__('Light Menu Hover Text Color', 'servicemaster'),
			)
		);
		...
		servicemaster_mikado_add_admin_field(
			array(
				...
				'default_value' => '',
				'label'         => esc_html__('Light Menu Active Text Color', 'servicemaster'),
			)
		);
		...
		servicemaster_mikado_add_admin_field(
			array(
				...
				'default_value' => '',
				'label'         => esc_html__('Light Menu Border Hover/Active Color', 'servicemaster'),
			)
		);

		$first_level_row4 = servicemaster_mikado_add_admin_row(
			array(
				'parent' => $first_level_group,
		...
		servicemaster_mikado_add_admin_field(
			array(
				...
				'default_value' => '',
				'label'         => esc_html__('Dark Menu Hover Text Color', 'servicemaster'),
			)
		);
		...
		servicemaster_mikado_add_admin_field(
			array(
				...
				'default_value' => '',
				'label'         => esc_html__('Dark Menu Active Text Color', 'servicemaster'),
			)
		);
		...
		servicemaster_mikado_add_admin_field(
			array(
				...
				'default_value' => '',
				'label'         => esc_html__('Dark Menu Border Hover/Active Color', 'servicemaster'),
			)
		);

		$first_level_row5 = servicemaster_mikado_add_admin_row(
			array(
				'parent' => $first_level_group,
		...
		servicemaster_mikado_add_admin_field(
			array(
				...
				'default_value' => '',
				'label'         => esc_html__('Hover Background Color Transparency', 'servicemaster'),
			)
		);
		...
		servicemaster_mikado_add_admin_field(
			array(
				...
				'default_value' => '',
				'label'         => esc_html__('Active Background Color Transparency', 'servicemaster'),
			)
		);

		$first_level_row6 = servicemaster_mikado_add_admin_row(
			array(
				'parent' => $first_level_group,
		...
		$first_level_row7 = servicemaster_mikado_add_admin_row(
			array(
				'parent' => $first_level_group,
		...
		servicemaster_mikado_add_admin_field(
			array(
				...
				'default_value' => '',
				'label'         => esc_html__('Padding Left/Right', 'servicemaster'),
				'args'          => array(
					'suffix' => 'px'
				)
			)
		...
		servicemaster_mikado_add_admin_field(
			array(
				...
				'default_value' => '',
				'label'         => esc_html__('Margin Left/Right', 'servicemaster'),
				'args'          => array(
					'suffix' => 'px'
				)
			)
		...
		$second_level_group = servicemaster_mikado_add_admin_group(
			array(
				'parent'      => $panel_main_menu,
				'name'        => 'second_level_group',
				'title'       => esc_html__('2nd Level Menu', 'servicemaster'),
				'description' => esc_html__('Define styles for 2nd level in Top Navigation Menu', 'servicemaster')
			)
		);

		$second_level_row1 = servicemaster_mikado_add_admin_row(
			array(
		...
		servicemaster_mikado_add_admin_field(
			array(
				...
				'default_value' => '',
				'label'         => esc_html__('Hover/Active Background Color', 'servicemaster')
			)
		);

		$second_level_row2 = servicemaster_mikado_add_admin_row(
			array(
				'parent' => $second_level_group,
		...
		servicemaster_mikado_add_admin_field(
			array(
				...
				'default_value' => '',
				'label'         => esc_html__('Padding Top/Bottom', 'servicemaster'),
				'args'          => array(
					'suffix' => 'px'
				)
			)
		...
		$second_level_row3 = servicemaster_mikado_add_admin_row(
			array(
				'parent' => $second_level_group,
		...
		$second_level_wide_group = servicemaster_mikado_add_admin_group(
			array(
				'parent'      => $panel_main_menu,
				'name'        => 'second_level_wide_group',
				'title'       => esc_html__('2nd Level Wide Menu', 'servicemaster'),
				'description' => esc_html__('Define styles for 2nd level in Wide Menu', 'servicemaster')
			)
		);

		$second_level_wide_row1 = servicemaster_mikado_add_admin_row(
			array(
		...
		$second_level_wide_row2 = servicemaster_mikado_add_admin_row(
			array(
				'parent' => $second_level_wide_group,
		...
		$second_level_wide_row3 = servicemaster_mikado_add_admin_row(
			array(
				'parent' => $second_level_wide_group,
		...
		$third_level_group = servicemaster_mikado_add_admin_group(
			array(
				'parent'      => $panel_main_menu,
				'name'        => 'third_level_group',
				'title'       => esc_html__('3nd Level Menu', 'servicemaster'),
				'description' => esc_html__('Define styles for 3nd level in Top Navigation Menu', 'servicemaster')
			)
		);

		$third_level_row1 = servicemaster_mikado_add_admin_row(
			array(
		...
		$third_level_row2 = servicemaster_mikado_add_admin_row(
			array(
				'parent' => $third_level_group,
		...
		$third_level_row3 = servicemaster_mikado_add_admin_row(
			array(
				'parent' => $third_level_group,
		...
		/***********************************************************/
		$third_level_wide_group = servicemaster_mikado_add_admin_group(
			array(
				'parent'      => $panel_main_menu,
				'name'        => 'third_level_wide_group',
				'title'       => esc_html__('3rd Level Wide Menu', 'servicemaster'),
				'description' => esc_html__('Define styles for 3rd level in Wide Menu', 'servicemaster')
			)
		);

		$third_level_wide_row1 = servicemaster_mikado_add_admin_row(
			array(
		...
		$third_level_wide_row2 = servicemaster_mikado_add_admin_row(
			array(
				'parent' => $third_level_wide_group,
		...
		$third_level_wide_row3 = servicemaster_mikado_add_admin_row(
			array(
				'parent' => $third_level_wide_group,
		...
		$panel_vertical_main_menu = servicemaster_mikado_add_admin_panel(
			array(
				'title'           => esc_html__('Vertical Main Menu', 'servicemaster'),
		...
		$drop_down_group = servicemaster_mikado_add_admin_group(
			array(
				...
				'title'       => esc_html__('Main Dropdown Menu', 'servicemaster'),
				'description' => esc_html__('Set a style for dropdown menu', 'servicemaster')
			)
		);

		$vertical_drop_down_row1 = servicemaster_mikado_add_admin_row(
			array(
				'parent' => $drop_down_group,
		...
		$group_vertical_first_level = servicemaster_mikado_add_admin_group(array(
			'name'        => 'group_vertical_first_level',
			'title'       => esc_html__('1st level', 'servicemaster'),
			'description' => esc_html__('Define styles for 1st level menu', 'servicemaster'),
			'parent'      => $panel_vertical_main_menu
		));

		$row_vertical_first_level_1 = servicemaster_mikado_add_admin_row(array(
		...
		$row_vertical_first_level_2 = servicemaster_mikado_add_admin_row(array(
		...
		$row_vertical_first_level_3 = servicemaster_mikado_add_admin_row(array(
		...
		$group_vertical_second_level = servicemaster_mikado_add_admin_group(array(
			'name'        => 'group_vertical_second_level',
			'title'       => esc_html__('2nd level', 'servicemaster'),
			'description' => esc_html__('Define styles for 2nd level menu', 'servicemaster'),
			'parent'      => $panel_vertical_main_menu
		));

		$row_vertical_second_level_1 = servicemaster_mikado_add_admin_row(array(
		...
		$row_vertical_second_level_2 = servicemaster_mikado_add_admin_row(array(
		...
		$row_vertical_second_level_3 = servicemaster_mikado_add_admin_row(array(
		...
		$group_vertical_third_level = servicemaster_mikado_add_admin_group(array(
			'name'        => 'group_vertical_third_level',
			'title'       => esc_html__('3rd level', 'servicemaster'),
			'description' => esc_html__('Define styles for 3rd level menu', 'servicemaster'),
			'parent'      => $panel_vertical_main_menu
		));

		$row_vertical_third_level_1 = servicemaster_mikado_add_admin_row(array(
		...
		$row_vertical_third_level_2 = servicemaster_mikado_add_admin_row(array(
		...
		$row_vertical_third_level_3 = servicemaster_mikado_add_admin_row(array(
		...
		$panel_mobile_header = servicemaster_mikado_add_admin_panel(array(
			'title' => esc_html__('Mobile header', 'servicemaster'),
		...
		servicemaster_mikado_add_admin_field(array(
			...
			'type'        => 'text',
			'label'       => esc_html__('Mobile Header Height', 'servicemaster'),
			'description' => esc_html__('Enter height for mobile header in pixels', 'servicemaster'),
		...
		servicemaster_mikado_add_admin_field(array(
			...
			'type'        => 'color',
			'label'       => esc_html__('Mobile Header Background Color', 'servicemaster'),
			'description' => esc_html__('Choose color for mobile header', 'servicemaster'),
			'parent'      => $panel_mobile_header
		));
		...
		servicemaster_mikado_add_admin_field(array(
			...
			'type'        => 'color',
			'label'       => esc_html__('Mobile Menu Background Color', 'servicemaster'),
			'description' => esc_html__('Choose color for mobile menu', 'servicemaster'),
			'parent'      => $panel_mobile_header
		));
		...
		servicemaster_mikado_add_admin_field(array(
			...
			'type'        => 'color',
			'label'       => esc_html__('Mobile Menu Item Separator Color', 'servicemaster'),
			'description' => esc_html__('Choose color for mobile menu horizontal separators', 'servicemaster'),
			'parent'      => $panel_mobile_header
		));
		...
		servicemaster_mikado_add_admin_field(array(
			...
			'type'        => 'text',
			'label'       => esc_html__('Logo Height For Mobile Header', 'servicemaster'),
			'description' => esc_html__('Define logo height for screen size smaller than 1000px', 'servicemaster'),
			'parent'      => $panel_mobile_header,
			'args'        => array(
				'col_width' => 3,
				'suffix'    => 'px'
		...
		servicemaster_mikado_add_admin_field(array(
			...
			'type'        => 'text',
			'label'       => esc_html__('Logo Height For Mobile Devices', 'servicemaster'),
			'description' => esc_html__('Define logo height for screen size smaller than 480px', 'servicemaster'),
			'parent'      => $panel_mobile_header,
			'args'        => array(
				'col_width' => 3,
				'suffix'    => 'px'
		...
		servicemaster_mikado_add_admin_field(array(
			...
			'type'        => 'color',
			'label'       => esc_html__('Navigation Text Color', 'servicemaster'),
			'description' => esc_html__('Define color for mobile navigation text', 'servicemaster'),
			'parent'      => $panel_mobile_header
		));
		...
		servicemaster_mikado_add_admin_field(array(
			...
			'type'        => 'color',
			'label'       => esc_html__('Navigation Hover/Active Color', 'servicemaster'),
			'description' => esc_html__('Define hover/active color for mobile navigation text', 'servicemaster'),
			'parent'      => $panel_mobile_header
		));
		...
		servicemaster_mikado_add_admin_field(array(
			...
			'type'        => 'font',
			'label'       => esc_html__('Navigation Font Family', 'servicemaster'),
			'description' => esc_html__('Define font family for mobile navigation text', 'servicemaster'),
			'parent'      => $panel_mobile_header
		));
		...
		servicemaster_mikado_add_admin_field(array(
			...
			'type'        => 'text',
			'label'       => esc_html__('Navigation Font Size', 'servicemaster'),
			'description' => esc_html__('Define font size for mobile navigation text', 'servicemaster'),
			'parent'      => $panel_mobile_header,
			'args'        => array(
				'col_width' => 3,
				'suffix'    => 'px'
		...
		servicemaster_mikado_add_admin_field(array(
			...
			'type'        => 'text',
			'label'       => esc_html__('Navigation Line Height', 'servicemaster'),
			'description' => esc_html__('Define line height for mobile navigation text', 'servicemaster'),
			'parent'      => $panel_mobile_header,
			'args'        => array(
				'col_width' => 3,
				'suffix'    => 'px'
		...
		servicemaster_mikado_add_admin_field(array(
			...
			'type'        => 'select',
			'label'       => esc_html__('Navigation Text Transform', 'servicemaster'),
			'description' => esc_html__('Define text transform for mobile navigation text', 'servicemaster'),
			'parent'      => $panel_mobile_header,
			'options'     => servicemaster_mikado_get_text_transform_array(true)
		));

		servicemaster_mikado_add_admin_field(array(
			'name'        => 'mobile_font_style',
			'type'        => 'select',
			'label'       => esc_html__('Navigation Font Style', 'servicemaster'),
			'description' => esc_html__('Define font style for mobile navigation text', 'servicemaster'),
			'parent'      => $panel_mobile_header,
			'options'     => servicemaster_mikado_get_font_style_array(true)
		));

		servicemaster_mikado_add_admin_field(array(
			'name'        => 'mobile_font_weight',
			'type'        => 'select',
			'label'       => esc_html__('Navigation Font Weight', 'servicemaster'),
			'description' => esc_html__('Define font weight for mobile navigation text', 'servicemaster'),
			'parent'      => $panel_mobile_header,
			'options'     => servicemaster_mikado_get_font_weight_array(true)
		));

		servicemaster_mikado_add_admin_section_title(array(
			'name'   => 'mobile_opener_panel',
			'parent' => $panel_mobile_header,
			'title'  => esc_html__('Mobile Menu Opener', 'servicemaster')
		));

		servicemaster_mikado_add_admin_field(array(
			'name'          => 'mobile_icon_pack',
			'type'          => 'select',
			'label'         => esc_html__('Mobile Navigation Icon Pack', 'servicemaster'),
			'default_value' => 'font_awesome',
			'description'   => esc_html__('Choose icon pack for mobile navigation icon', 'servicemaster'),
			'parent'        => $panel_mobile_header,
		...
		servicemaster_mikado_add_admin_field(array(
			...
			'type'        => 'color',
			'label'       => esc_html__('Mobile Navigation Icon Color', 'servicemaster'),
			'description' => esc_html__('Choose color for icon header', 'servicemaster'),
			'parent'      => $panel_mobile_header
		));
		...
		servicemaster_mikado_add_admin_field(array(
			...
			'type'        => 'color',
			'label'       => esc_html__('Mobile Navigation Icon Hover Color', 'servicemaster'),
			'description' => esc_html__('Choose hover color for mobile navigation icon ', 'servicemaster'),
			'parent'      => $panel_mobile_header
		));
		...
		servicemaster_mikado_add_admin_field(array(
			...
			'type'        => 'text',
			'label'       => esc_html__('Mobile Navigation Icon size', 'servicemaster'),
			'description' => esc_html__('Choose size for mobile navigation icon', 'servicemaster'),
			'parent'      => $panel_mobile_header,
			'args'        => array(
				'col_width' => 3,
				'suffix'    => 'px'
	...
	add_action('servicemaster_mikado_options_map', 'servicemaster_mikado_header_options_map', 3);
