...
class HeaderStandardExtended extends HeaderType {
	...
	public function __construct() {
		...
		if (!is_admin()) {
			...
			$logoAreaHeight = servicemaster_mikado_filter_px(servicemaster_mikado_options()->getOptionValue('logo_area_height_header_standard_extended'));
			$this->logoAreaHeight = $logoAreaHeight !== '' ? intval($logoAreaHeight) : 100;

			$menuAreaHeight = servicemaster_mikado_filter_px(servicemaster_mikado_options()->getOptionValue('menu_area_height_header_standard_extended'));
	...
	public function headerPerPageStyles($style) {
		...
		$disable_logo_border = servicemaster_mikado_get_meta_field_intersect('logo_area_border_header_standard_extended', $id) == 'no';
		$disable_logo_grid_border = servicemaster_mikado_get_meta_field_intersect('logo_area_in_grid_border_header_standard_extended', $id) == 'no';

		$disable_menu_grid_shadow = servicemaster_mikado_get_meta_field_intersect('menu_area_in_grid_shadow_header_standard_extended', $id) == 'no';
	...
	public function loadTemplate($parameters = array()) {
		...
		$parameters['logo_area_in_grid'] = servicemaster_mikado_get_meta_field_intersect('logo_area_in_grid_header_standard_extended', $id) == 'yes' ? true : false;
		$parameters['menu_area_in_grid'] = servicemaster_mikado_get_meta_field_intersect('menu_area_in_grid_header_standard_extended', $id) == 'yes' ? true : false;

		$parameters = apply_filters('servicemaster_mikado_header_standard_extended_parameters', $parameters);
	...
	public function calculateHeightOfTransparency() {
		...
		} elseif (servicemaster_mikado_options()->getOptionValue('logo_area_background_color_header_standard_extended') == '') {
			$logoAreaTransparent = servicemaster_mikado_options()->getOptionValue('logo_area_grid_background_color_header_standard_extended') !== '' &&
				servicemaster_mikado_options()->getOptionValue('logo_area_grid_background_transparency_header_standard_extended') !== '1';
		} else {
			$logoAreaTransparent = servicemaster_mikado_options()->getOptionValue('logo_area_background_color_header_standard_extended') !== '' &&
				servicemaster_mikado_options()->getOptionValue('logo_area_background_transparency_header_standard_extended') !== '1';
		}
		...
		} elseif (servicemaster_mikado_options()->getOptionValue('menu_area_background_color_header_standard_extended') == '') {
			$menuAreaTransparent = servicemaster_mikado_options()->getOptionValue('menu_area_grid_background_color_header_standard_extended') !== '' &&
				servicemaster_mikado_options()->getOptionValue('menu_area_grid_background_transparency_header_standard_extended') !== '1';
		} else {
			$menuAreaTransparent = servicemaster_mikado_options()->getOptionValue('menu_area_background_color_header_standard_extended') !== '' &&
				servicemaster_mikado_options()->getOptionValue('menu_area_background_transparency_header_standard_extended') !== '1';
		}
	...
	public function calculateHeightOfCompleteTransparency() {
		...
		if (get_post_meta($id, 'mkd_logo_area_background_color_header_standard_extended_meta', true) !== '') {
			...
			$logoAreaTransparent = servicemaster_mikado_options()->getOptionValue('logo_area_grid_background_color_header_standard_extended') !== '' &&
				servicemaster_mikado_options()->getOptionValue('logo_area_grid_background_transparency_header_standard_extended') === '0';
		} else {
			$logoAreaTransparent = servicemaster_mikado_options()->getOptionValue('logo_area_background_color_header_standard_extended') !== '' &&
				servicemaster_mikado_options()->getOptionValue('logo_area_background_transparency_header_standard_extended') === '0';
		}
		...
		if (get_post_meta($id, 'mkd_menu_area_background_color_header_standard_extended_meta', true) !== '') {
			...
			$menuAreaTransparent = servicemaster_mikado_options()->getOptionValue('menu_area_grid_background_color_header_standard_extended') !== '' &&
				servicemaster_mikado_options()->getOptionValue('menu_area_grid_background_transparency_header_standard_extended') === '0';
		} else {
			$menuAreaTransparent = servicemaster_mikado_options()->getOptionValue('menu_area_background_color_header_standard_extended') !== '' &&
				servicemaster_mikado_options()->getOptionValue('menu_area_background_transparency_header_standard_extended') === '0';
		}
