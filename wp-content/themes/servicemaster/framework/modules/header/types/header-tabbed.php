...
class HeaderTabbed extends HeaderType {
	...
	public function __construct() {
		...
		if (!is_admin()) {
			...
			$menuAreaHeight = servicemaster_mikado_filter_px(servicemaster_mikado_options()->getOptionValue('menu_area_height_header_tabbed'));
	...
	public function loadTemplate($parameters = array()) {
		...
		$parameters = apply_filters('servicemaster_mikado_header_tabbed_parameters', $parameters);
	...
	public function calculateHeightOfTransparency() {
		...
		if (get_post_meta($id, 'mkd_menu_area_background_color_header_tabbed_meta', true) !== '') {
			...
			$menuAreaTransparent = servicemaster_mikado_options()->getOptionValue('menu_area_background_color_header_tabbed') !== '' &&
				servicemaster_mikado_options()->getOptionValue('menu_area_background_transparency_header_tabbed') !== '1';
		}
	...
	public function calculateHeightOfCompleteTransparency() {
		...
		if (get_post_meta($id, 'mkd_menu_area_background_color_header_tabbed_meta', true) !== '') {
			...
			$menuAreaTransparent = servicemaster_mikado_options()->getOptionValue('menu_area_background_color_header_tabbed') !== '' &&
				servicemaster_mikado_options()->getOptionValue('menu_area_background_transparency_header_tabbed') === '0';
		}
