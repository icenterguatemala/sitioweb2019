...
class HeaderVertical extends HeaderType {
	...
	public function loadTemplate($parameters = array()) {
        ...
        $parameters['holder_class'] = servicemaster_mikado_vertical_haeder_holder_class();

        $parameters = apply_filters('servicemaster_mikado_header_vertical_parameters', $parameters);
