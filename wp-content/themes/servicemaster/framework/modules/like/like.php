<?php
class ServiceMasterMikadoLike {

	private static $instance;

	private function __construct() {
		add_action('wp_enqueue_scripts', array( $this, 'enqueue_scripts'));
		add_action('wp_ajax_servicemaster_mikado_like', array( $this, 'ajax'));
		add_action('wp_ajax_nopriv_servicemaster_mikado_like', array( $this, 'ajax'));
	}
	...
	public function add_like() {
		...
		$title = esc_html__('Like this', 'servicemaster');
		if( isset($_COOKIE['mkd-like_'. $post->ID]) ){
			$class = 'mkd-like liked';
			$title = esc_html__('You already like this!', 'servicemaster');
		}
...
global $servicemaster_like;
$servicemaster_like = ServiceMasterMikadoLike::get_instance();
