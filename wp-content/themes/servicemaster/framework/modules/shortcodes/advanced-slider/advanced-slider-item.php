...
namespace ServiceMaster\Modules\Shortcodes\AdvancedSliderItem;

use ServiceMaster\Modules\Shortcodes\Lib\ShortcodeInterface;

class AdvancedSliderItem implements ShortcodeInterface {
    private $base;

    public function __construct() {
        $this->base = 'mkd_advanced_slider_item';
    ...
    public function vcMap() {
        vc_map(array(
            'name'                      => esc_html__('Advanced Slider', 'servicemaster'),
            'base'                      => $this->base,
            'category'                  => 'by MIKADO',
            'icon'                      => 'icon-wpb-advanced-slider-item extended-custom-icon',
            'allowed_container_element' => 'vc_row',
            'as_child'                  => array('only' => 'mkd_advanced_slider'),
            'params'                    => array(
                array(
                    'type'        => 'attach_image',
                    'heading'     => esc_html__('Card Header Image', 'servicemaster'),
                    'param_name'  => 'header_image',
                    'description' => esc_html__('Choose image from media library', 'servicemaster'),
                    'admin_label' => true
                ),
                array(
                    'type'        => 'colorpicker',
                    'heading'     => esc_html__('Card Background Color', 'servicemaster'),
                    'param_name'  => 'background_color',
                    'description' => esc_html__('Choose background Color', 'servicemaster'),
                    'admin_label' => true
                ),
                array(
                    'type'        => 'attach_images',
                    'heading'     => esc_html__('Slider Images', 'servicemaster'),
                    'param_name'  => 'images',
                    'description' => esc_html__('Choose image from media library', 'servicemaster'),
                    'admin_label' => true
                ),
                array(
                    'type'        => 'dropdown',
                    'heading'     => esc_html__('Set Middle Slide as Active on Load', 'servicemaster'),
                ...
                array(
                    'type'        => 'dropdown',
                    'heading'     => esc_html__('Center Slide', 'servicemaster'),
                    'param_name'  => 'center_slider',
                    'description' => esc_html__('Set every slide in center of content', 'servicemaster'),
                    'value'       => array(
                        esc_html__('No', 'servicemaster')  => 'false',
                        esc_html__('Yes', 'servicemaster') => 'true'
                    ),
                ...
                array(
                    ...
                    'description' => esc_html__('Show curved edges on every slide', 'servicemaster'),
                    'value'       => array(
                ...
                array(
                    ...
                    'description' => esc_html__('Show hover animation on every slide', 'servicemaster'),
                    'value'       => array(
                        esc_html__('No', 'servicemaster')  => 'no',
                        esc_html__('Yes', 'servicemaster') => 'yes'
                    ),
                ...
                array(
                    'type'        => 'dropdown',
                    'heading'     => esc_html__('Show Navigation Bullets', 'servicemaster'),
                    'param_name'  => 'show_bullets',
                    'description' => esc_html__('Show navigation bullets under the slider', 'servicemaster'),
                    'value'       => array(
                        esc_html__('Yes', 'servicemaster') => 'yes',
                        esc_html__('No', 'servicemaster')  => 'no'
                    ),
    ...
    public function render($atts, $content = null) {
        ...
        return servicemaster_mikado_get_shortcode_module_template_part('templates/advanced-slider-item-template', 'advanced-slider', '', $params);
    }
