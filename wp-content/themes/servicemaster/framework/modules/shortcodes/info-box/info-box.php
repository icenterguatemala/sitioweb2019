<?php
namespace ServiceMaster\Modules\Shortcodes\InfoBox;
...
class InfoBox implements ShortcodeInterface {
	...
	public function vcMap() {
		vc_map(array(
			'name'                      => esc_html__('Info Box', 'servicemaster'),
			'base'                      => $this->base,
			'category'                  => 'by MIKADO',
			'icon'                      => 'icon-wpb-info-box extended-custom-icon',
			'allowed_container_element' => 'vc_row',
			'params'                    => array_merge(
				servicemaster_mikado_icon_collections()->getVCParamsArray('', '', true),
				array(
					array(
						'type'        => 'textfield',
					...
					array(
						...
						'value'       => array(
							esc_html__('Same Window', 'servicemaster') => '',
					...
					array(
						'type'        => 'colorpicker',
						'heading'     => esc_html__('Button Hover Background Color', 'servicemaster'),
					...
					array(
						'type'        => 'colorpicker',
						'heading'     => esc_html__('Button Hover Text Color', 'servicemaster'),
					...
					array(
						'type'        => 'colorpicker',
						'heading'     => esc_html__('Button Hover Border Color', 'servicemaster'),
	...
	public function render($atts, $content = null) {
		...
		$defaultAtts = array_merge($defaultAtts, servicemaster_mikado_icon_collections()->getShortcodeParams());
		...
		return servicemaster_mikado_get_shortcode_module_template_part('templates/info-box-template', 'info-box', '', $params);
	}
