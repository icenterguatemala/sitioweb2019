<?php
namespace ServiceMaster\Modules\PieCharts\PieChartBasic;
...
class PieChartBasic implements ShortcodeInterface {
	...
	public function vcMap() {
		...
		vc_map(array(
			'name'                      => esc_html__('Pie Chart', 'servicemaster'),
			'base'                      => $this->getBase(),
			...
			'params'                    => array(
				array(
					'type'        => 'dropdown',
					'heading'     => esc_html__('Type of Central text', 'servicemaster'),
					'param_name'  => 'type_of_central_text',
					'value'       => array(
						esc_html__('Percent', 'servicemaster') => 'percent',
				...
				array(
					'type'        => 'textfield',
					'heading'     => esc_html__('Size(px)', 'servicemaster'),
					'param_name'  => 'size',
					'description' => '',
					'admin_label' => true,
				...
				array(
					'type'        => 'colorpicker',
					'heading'     => esc_html__('Active Color', 'servicemaster'),
				...
				array(
					'type'        => 'colorpicker',
					'heading'     => esc_html__('Inactive Color', 'servicemaster'),
				...
				array(
					'type'        => 'textfield',
					'heading'     => esc_html__('Margin below chart (px)', 'servicemaster'),
				...
				array(
					'type'        => 'dropdown',
					'heading'     => esc_html__('Typography Style', 'servicemaster'),
	...
	public function render($atts, $content = null) {
		...
		$params['active_color'] = $params['active_color'] !== '' ? $params['active_color'] : servicemaster_mikado_get_first_main_color();
		...
		$html = servicemaster_mikado_get_shortcode_module_template_part('templates/pie-chart-basic', 'piecharts/piechartbasic', '', $params);
