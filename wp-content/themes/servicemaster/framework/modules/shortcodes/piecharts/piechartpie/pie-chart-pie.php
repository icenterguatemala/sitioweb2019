...
class PieChartPie implements ShortcodeInterface {
	...
	public function vcMap() {
		...
		vc_map(array(
			'name'                      => esc_html__('Pie Chart 2 (Pie)', 'servicemaster'),
			'base'                      => $this->getBase(),
			'category'                  => 'by MIKADO',
	...
	public function render($atts, $content = null) {
		...
		$html = servicemaster_mikado_get_shortcode_module_template_part('templates/pie-chart-pie', 'piecharts/piechartpie', '', $params);
