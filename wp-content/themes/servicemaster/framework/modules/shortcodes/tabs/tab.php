<?php
namespace ServiceMaster\Modules\Tab;
...
class Tab implements ShortcodeInterface {
	...
	public function vcMap() {
		...
		vc_map(array(
			'name'                    => esc_html__('Tab', 'servicemaster'),
			'base'                    => $this->getBase(),
	...
	public function render($atts, $content = null) {
		...
		$default_atts = array(
			'tab_title'        => esc_html__('Tab', 'servicemaster'),
			'tab_id'           => '',
			'background_image' => ''
		);
		...
		$output = '';
		$output .= servicemaster_mikado_get_shortcode_module_template_part('templates/tab_content', 'tabs', '', $params);
