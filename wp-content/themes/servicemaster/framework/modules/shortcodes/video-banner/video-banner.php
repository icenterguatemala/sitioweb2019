<?php
namespace ServiceMaster\Modules\Shortcodes\VideoBanner;
...
class VideoBanner implements ShortcodeInterface {
	...
	public function vcMap() {
		vc_map(array(
			'name'                      => esc_html__('Video Banner', 'servicemaster'),
			'base'                      => $this->base,
			'category'                  => 'by MIKADO',
			...
			'params'                    => array(
				...
				array(
					'type'        => 'attach_image',
					'heading'     => esc_html__('Video Banner', 'servicemaster'),
	...
	public function render($atts, $content = null) {
		...
		return servicemaster_mikado_get_shortcode_module_template_part('templates/video-banner', 'video-banner', '', $params);
	}
