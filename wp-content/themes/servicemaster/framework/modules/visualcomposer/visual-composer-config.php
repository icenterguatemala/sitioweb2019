...
if (!function_exists('servicemaster_mikado_configure_visual_composer')) {
	/**
	 * Configuration for Visual Composer
	 * Hooks on vc_after_init action
	 */
	function servicemaster_mikado_configure_visual_composer() {
	...
	add_action('vc_after_init', 'servicemaster_mikado_configure_visual_composer');

}


if (!function_exists('servicemaster_mikado_configure_visual_composer_grid_elemets')) {
	...
	function servicemaster_mikado_configure_visual_composer_grid_elemets() {
	...
	add_action('vc_after_init', 'servicemaster_mikado_configure_visual_composer_grid_elemets');
}


if (!function_exists('servicemaster_mikado_configure_visual_composer_frontend_editor')) {
	/**
	 * Configuration for Visual Composer FrontEnd Editor
	 * Hooks on vc_after_init action
	 */
	function servicemaster_mikado_configure_visual_composer_frontend_editor() {
	...
	add_action('vc_after_init', 'servicemaster_mikado_configure_visual_composer_frontend_editor');
}
...
if (class_exists('WPBakeryShortCode')) {
    ...
    class WPBakeryShortCode_Mkd_Item_Showcase_Item extends WPBakeryShortCode {
    }
}

/*** Row ***/
if (!function_exists('servicemaster_mikado_vc_row_map')) {
	/**
	 * Map VC Row shortcode
	 * Hooks on vc_after_init action
	 */
	function servicemaster_mikado_vc_row_map() {
		...
		vc_add_param('vc_row', array(
			'type'       => 'dropdown',
			'class'      => '',
			'heading'    => esc_html__('Row Type', 'servicemaster'),
			'param_name' => 'row_type',
			'value'      => array(
				esc_html__('Row', 'servicemaster')      => 'row',
				esc_html__('Parallax', 'servicemaster') => 'parallax'
			)
		));
		...
		vc_add_param('vc_row', array(
			'type'       => 'dropdown',
			'class'      => '',
			'heading'    => esc_html__('Content Width', 'servicemaster'),
			'param_name' => 'content_width',
			'value'      => array(
				esc_html__('Full Width', 'servicemaster') => 'full-width',
				esc_html__('In Grid', 'servicemaster')    => 'grid'
			)
		));
		...
		vc_add_param('vc_row', array(
			'type'       => 'dropdown',
			'class'      => '',
			'heading'    => esc_html__('Header Style', 'servicemaster'),
			'param_name' => 'header_style',
			'value'      => array(
				esc_html__('Default', 'servicemaster') => '',
				esc_html__('Light', 'servicemaster')   => 'mkd-light-header',
				esc_html__('Dark', 'servicemaster')    => 'mkd-dark-header'
			),
			'dependency' => array(
				'element' => 'row_type',
		...
		vc_add_param('vc_row', array(
			'type'        => 'textfield',
			'class'       => '',
			'heading'     => esc_html__('Anchor ID', 'servicemaster'),
			'param_name'  => 'anchor',
			'value'       => '',
			'description' => esc_html__('For example "home"', 'servicemaster')
		));
		...
		vc_add_param('vc_row', array(
			'type'        => 'dropdown',
			'class'       => '',
			'heading'     => esc_html__('Video Background', 'servicemaster'),
			'value'       => array(
				esc_html__('No', 'servicemaster')  => '',
				esc_html__('Yes', 'servicemaster') => 'show_video'
			),
			'param_name'  => 'video',
			'description' => '',
			'dependency'  => array(
		...
		vc_add_param('vc_row', array(
			'type'        => 'dropdown',
			'class'       => '',
			'heading'     => esc_html__('Video Overlay', 'servicemaster'),
			'value'       => array(
				esc_html__('No', 'servicemaster')  => '',
				esc_html__('Yes', 'servicemaster') => 'show_video_overlay'
			),
		...
		vc_add_param('vc_row', array(
			'type'        => 'attach_image',
			'class'       => '',
			'heading'     => esc_html__('Video Overlay Image (pattern)', 'servicemaster'),
			'value'       => '',
		...
		vc_add_param('vc_row', array(
			'type'        => 'textfield',
			'class'       => '',
			'heading'     => esc_html__('Video Background (webm) File URL', 'servicemaster'),
			'value'       => '',
		...
		vc_add_param('vc_row', array(
			'type'        => 'textfield',
			'class'       => '',
			'heading'     => esc_html__('Video Background (mp4) file URL', 'servicemaster'),
			'value'       => '',
		...
		vc_add_param('vc_row', array(
			'type'        => 'textfield',
			'class'       => '',
			'heading'     => esc_html__('Video Background (ogv) file URL', 'servicemaster'),
			'value'       => '',
		...
		vc_add_param('vc_row', array(
			'type'        => 'attach_image',
			'class'       => '',
			'heading'     => esc_html__('Video Preview Image', 'servicemaster'),
			'value'       => '',
		...
		vc_add_param("vc_row", array(
			'type'        => 'dropdown',
			'class'       => '',
			'heading'     => esc_html__('Full Screen Height', 'servicemaster'),
		...
		vc_add_param('vc_row', array(
			'type'       => 'dropdown',
			'class'      => '',
			'heading'    => esc_html__('Vertically Align Content In Middle', 'servicemaster'),
		...
		vc_add_param('vc_row', array(
			'type'       => 'textfield',
			'class'      => '',
			'heading'    => esc_html__('Section Height', 'servicemaster'),
		...
		vc_add_param('vc_row', array(
			'type'        => 'attach_image',
			'class'       => '',
			'heading'     => esc_html__('Parallax Background image', 'servicemaster'),
			'value'       => '',
			'param_name'  => 'parallax_background_image',
			'description' => esc_html__('Please note that for parallax row type, background image from Design Options will not work so you should to fill this field', 'servicemaster'),
			'dependency'  => array(
				'element' => 'row_type',
				'value'   => array('parallax')
			)
		...
		vc_add_param('vc_row', array(
			'type'       => 'textfield',
			'class'      => '',
			'heading'    => esc_html__('Parallax speed', 'servicemaster'),
		...
		vc_add_param('vc_row', array(
			'type'        => 'dropdown',
			'heading'     => esc_html__('CSS Animation', 'servicemaster'),
		...
		vc_add_param('vc_row', array(
			'type'        => 'textfield',
			'heading'     => esc_html__('Transition delay (ms)', 'servicemaster'),
	...
	add_action('vc_after_init', 'servicemaster_mikado_vc_row_map');
}
