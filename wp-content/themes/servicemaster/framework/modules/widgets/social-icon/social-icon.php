 ...
 */
class ServiceMasterMikadoSocialIconWidget extends ServiceMasterMikadoWidget {
	/**
	...
	public function __construct() {
		parent::__construct(
			...
			esc_html__('Mikado Social Icon Widget', 'servicemaster') // Name
		);
	...
	protected function setParams() {
		$this->params = array_merge(
			servicemaster_mikado_icon_collections()->getSocialIconWidgetParamsArray(),
			array(
				array(
					'type'        => 'textfield',
					'title'       => esc_html__('Link', 'servicemaster'),
					'name'        => 'link',
					'description' => ''
				),
				array(
					'type'        => 'dropdown',
					'title'       => esc_html__('Target', 'servicemaster'),
					'name'        => 'target',
					'options'     => array(
				...
				array(
					'type'        => 'textfield',
					'title'       => esc_html__('Text Size (px)', 'servicemaster'),
					'name'        => 'text_size',
					'description' => ''
				),
				array(
				...
				array(
					'type'        => 'textfield',
					'title'       => esc_html__('Hover Color', 'servicemaster'),
					'name'        => 'hover_color',
					'description' => ''
				),
				array(
					'type'        => 'textfield',
					'title'       => esc_html__('Margin', 'servicemaster'),
					'name'        => 'margin',
	...
	public function widget($args, $instance) {
		...
		<a class="mkd-social-icon-widget-holder" <?php echo servicemaster_mikado_get_inline_attr($hover_color, 'data-hover-color'); ?> <?php servicemaster_mikado_inline_style($social_icon_styles) ?>
		   href="<?php echo esc_html($link); ?>" target="<?php echo esc_attr($target); ?>">
